...
if game.PlaceId ~= 13864667823 then
	...
	local SelectedItem = "Golden Apple"
	local SelectedItem2 = "Armor"
	local Damange = 5
	local namecall
	...
	local function GetBestTool()
		for i, v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Assets.Note.Note.Note:GetChildren()) do
			if v.Name:match("Circle") and v.Visible == true then
				GiveItem2(tostring(v.Name:gsub("Circle", "")))
			end
		end
	end
	...
	local function hitpizza()
		local A_1ES = game:GetService("Workspace").PizzaBossAlec.BadGuyPizza
	local A_2ES = 32.4
	local A_3ES = 4
	local Event = game:GetService("ReplicatedStorage").Events.HitBadguy
	Event:FireServer(A_1ES, A_2ES, A_3ES)
	end

	local function HitBrute()
		local A_1ER = game:GetService("Workspace").BadGuyBrute
		local A_2ER = 64.8
		local A_3ER = 4
		local Event = game:GetService("ReplicatedStorage").Events.HitBadguy
		Event:FireServer(A_1ER, A_2ER, A_3ER)
	end
	...
	local function GetEvilEnding()
		fireclickdetector(workspace.CrowbarBrute.ClickDetector)
	end

	local function GetPage()
		local Event = game:GetService("ReplicatedStorage").Events.AtticDoor2
		Event:FireServer()
		wait(5)
		local A_1WE = 3
		local A_2WE = "1"
		local Event = game:GetService("ReplicatedStorage").Events.PagesReplicate
		Event:FireServer(A_1WE, A_2WE)
		wait(1)
		local A_11 = 3
		local A_22 = "2"
		local Event = game:GetService("ReplicatedStorage").Events.PagesReplicate
		...
		local A_222 = "3"
		local Event = game:GetService("ReplicatedStorage").Events.PagesReplicate
		Event:FireServer(A_111, A_222)
		wait(1)
		local A_169 = 3
		local A_269 = "4"
		local Event = game:GetService("ReplicatedStorage").Events.PagesReplicate
		Event:FireServer(A_169, A_269)
		wait(1)
		local A_9111 = 3
		local A_9112 = "5"
		local Event = game:GetService("ReplicatedStorage").Events.PagesReplicate
		Event:FireServer(A_9111, A_9112)
		wait(1)
		local A_13 = 3
		local A_23 = "6"
		local Event = game:GetService("ReplicatedStorage").Events.PagesReplicate
		Event:FireServer(A_13, A_23)
		wait(2)
	end

	local function GetOriginEnding()
		T = 5
	...
	local function GetGAppleBadge()
		if game:GetService("Workspace"):FindFirstChild("FallenTrees") then
			...
			Notify("Error", "Golden Apple Has Not Spawned Yet, Please Wait Until the First Wave.", 'rbxassetid://7733911828', 3)
		end
	end
	...
	local Tab = Window:MakeTab({
		Name = "Game Breaking",
		Icon = "rbxassetid://7743873871",
		PremiumOnly = false
	})
	Tab:AddLabel("Server-Side Deletion(Fe)")
	...
	Tab:AddButton({
		...
		Callback = function()
			...
			for _, Object in pairs(workspace:GetChildren()) do
				if not Object:IsA("Camera") and not Object:IsA("TheHouse")   then
			...
			for i, v in pairs(game:GetService("Workspace").TheHouse:GetChildren()) do
				if v.Name ~= "FloorLayer" and v.Name ~= "Case1" and v.Name ~= "Case2" then
					Delete(v)
				end
			end
		end    
	...
	Tab:AddButton({
		Name = "Delete Everything(Except House)",
		Callback = function()
			local Players = game:GetService("Players")
	...
	Tab:AddButton({
		...
		Callback = function()
			...
			for i = 1, T do
			wait()
			Delete(game:GetService("Workspace").Trees.DeadTree)
			Delete(game:GetService("Workspace").PlacingTrees)
			Delete(game:GetService("Workspace").ChopTree)
			end
		end    
	})
	Tab:AddButton({
		Name = "Delete Bambles",
		Callback = function()
			Delete(game:GetService("Workspace").Bambles)
		end    
	})
	Tab:AddButton({
		Name = "Delete All Light",
		Callback = function()
			T = 50

			for i = 1, T do
			wait()
			Delete(game:GetService("Workspace").TheHouse.Light)
			Delete(game:GetService("Workspace").TheHouse.TopLight)
			Delete(game:GetService("Workspace").TheHouse.Light["Hanging Light"])
			Delete(game:GetService("Workspace").OutsideLights)
			Delete(game:GetService("Workspace").StreetLights)
			Delete(game:GetService("Workspace").WarningLights)
			Delete(game:GetService("Workspace").DoorLights)
			Delete(game:GetService("Workspace").FinalLight)
			end
		end    
	})
	Tab:AddTextbox({
	...
	Tab:AddButton({
		Name = "Delete Big Switch Power Display",
		Callback = function()
			Delete(game:GetService("Workspace").TheHouse.PowerDisplay)
		end    
	})
	Tab:AddButton({
		Name = "Delete Big Switch",
		Callback = function()
			Delete(game:GetService("Workspace").BigSwitch)
		end    
	})
	Tab:AddButton({
		Name = "Delete Doors 1",
		Callback = function()
			Delete(game:GetService("Workspace").Doors1)
		end    
	})
	Tab:AddButton({
		Name = "Delete Doors 2",
		Callback = function()
			Delete(game:GetService("Workspace").Doors2)
		end    
	})
	Tab:AddButton({
	...
	Tab:AddButton({
		Name = "Delete All Dresser",
		Callback = function()
			Delete(game:GetService("Workspace").Dressers)
			Delete(game:GetService("Workspace").AtticDresser)
		end 
	})
	Tab:AddButton({
		Name = "Delete Dinning Room",
		Callback = function()
			Delete(game:GetService("Workspace").TheHouse.Dining)
		end    
	})
	Tab:AddButton({
		Name = "Delete Fight Door",
		Callback = function()
			Delete(game:GetService("Workspace").TheHouse.MetalBitBreakRoom)
		end    
	})
	Tab:AddButton({
		Name = "Delete Ladder",
		Callback = function()
			Delete(game:GetService("Workspace").TheHouse.Case2)
			Delete(game:GetService("Workspace").TheHouse.Case1)
		end    
	})
	Tab:AddButton({
		Name = "Delete TV",
	...
	Tab:AddButton({
		...
		Callback = function()
			if game:GetService("Workspace"):FindFirstChild("Villainess") then
				...
				Notify('Warning', "Scary Marry Is Already Deleted Or Boss Fight Hasnt Started!", 'rbxassetid://7733911828', 7)
			end
		end
	})
	Tab:AddButton({
		...
		Callback = function()
			if game:GetService("Workspace"):FindFirstChild("BigBoss") then
				...
				Notify('Warning', "Scary Larry Is Already Deleted Or Boss Fight Hasnt Started!", 'rbxassetid://7733911828', 7)
			end
		end
	})
	Tab:AddButton({
		Name = "Delete Agent Boss",
		Callback = function()
			for i, v in pairs(game:GetService("ReplicatedStorage"):FindFirstChild("AgentBoss"):GetDescendants()) do
				if game:GetService("ReplicatedStorage"):FindFirstChild("AgentBoss") then
					Delete(game:GetService("ReplicatedStorage").AgentBoss[v])
				else
					Notify('Warning', "Agent Is Already Deleted Or Boss Fight Hasnt Started!", 'rbxassetid://7733911828', 7)
				end
			end
		end
	})
	...
	Tab:AddButton({
		Name = "Remove Rains For Everyone",
		Callback = function()
			Delete(game:GetService("Workspace").Rains)
		end    
	})
	Tab:AddButton({
	...
	Tab:AddDropdown({
		...
		Callback = function(Value)
			if Value == 'Book' or Value == 'Phone' then
				Notify('Warning', Value .. " Wont Work Unless You Own The Corresponding Gamepass.", 'rbxassetid://7733911828', 7)
			end
			SelectedItem2 = Value
		end
	})
	...
	Tab:AddButton({
		...
		Callback = function()
			loadstring(game:HttpGet('https://raw.githubusercontent.com/RamaTheDL/RobloxScript/main/Break%20In(2)/FE%20Overpowered%20LinkedSword.lua'))()
		end
	})
	Tab:AddButton({
		Name = "Death Note Item",
		Callback = function()
			loadstring(game:HttpGet('https://raw.githubusercontent.com/RamaTheDL/RobloxScript/main/Break%20In(2)/Fe%20Death%20Note.lua'))()
		end
	})
	Tab:AddButton({
		Name = "Fe Boombox",
		Callback = function()
			loadstring(game:HttpGet('https://raw.githubusercontent.com/RamaTheDL/RobloxScript/main/Break%20In(2)/Fe%20Boombox.lua'))()
		end
	})
	Tab:AddButton({
		Name = "Free Respawn",
		Callback = function()
			if LocalPlayer.PlayerGui:FindFirstChild("Respawn") then
				if LocalPlayer.PlayerGui:FindFirstChild("Respawn").Enabled == false then
					Notify('Info', "only works if you die(Respawn you from death)", 'rbxassetid://7733911828', 7)
				else
					LocalPlayer.PlayerGui.Respawn:Destroy()
					loadstring(game:HttpGet('https://raw.githubusercontent.com/RamaTheDL/RobloxScript/main/Break%20In(2)/Free%20Revive.lua'))()
				end
			else
				Notify('Info', "only works if you die(Respawn you from death)", 'rbxassetid://7733911828', 7)
			end
	...
	Tab:AddToggle({
		...
		Callback = function(Value)
			...
			if RemoveSlipping == true then
				Notify('Credits To', "Leo Dicap On V3rmillion For Making This Feature!", 'rbxassetid://7733911828', 7)
			end
		end
	})
	Tab:AddToggle({
	...
	Tab:AddButton({
		Name = "Easy Mode",
		Callback = function()
			loadstring(game:HttpGet('https://raw.githubusercontent.com/RamaTheDL/RobloxScript/main/Break%20In(2)/Easy%20Mode.lua'))()
		end    
	})
	local Section = Tab:AddSection({
		Name = "Others"
	...
	Tab:AddButton({
		Name = "Get Secret Ending",
		Callback = function()
			GetSecretEnding()
		end
	})
	Tab:AddButton({
		Name = "Get Evil Ending - Press This Once(1)",
		Callback = function()
			GetDog()
			task.wait(5)
			GetAgent()
	...
	Tab:AddToggle({
		Name = "Get Evil Ending(2)",
		Default = false,
		Callback = function(Value)
			if Value == true then
				if game:GetService("Workspace").TheHouse.Projector.Screen.White.WaveScreen.TextLabel.Text == 'WAVE <font color="#ff4343">1</font> of 3' then
					Notify('Notification!', "You have to wait for the next 2 Wave.", 'rbxassetid://7733911828', 7)
				elseif game:GetService("Workspace").TheHouse.Projector.Screen.White.WaveScreen.TextLabel.Text == 'WAVE <font color="#ff4343">2</font> of 3' then
					Notify('Notification!', "You have to wait for the next 1 Wave.", 'rbxassetid://7733911828', 7)
				elseif game:GetService("Workspace").TheHouse.Projector.Screen.White.WaveScreen.TextLabel.Text == 'WAVE <font color="#ff4343">3</font> of 3' then
					Notify('Notification!', "Waiting Gold Crowbar to spawn..", 'rbxassetid://7733911828', 3)
					while Value do
						if game:GetService("ReplicatedStorage").GoldCrowbarClickable.Part.Visible == true then
				    		GetEvilEnding()
						else
							print("No Gold Crowbar")
						end
						wait(0.69)
					end
				end
	...
	--[[
	local Section = Tab:AddSection({
		Name = "Origin Ending - Tutorial"
	})
	Tab:AddParagraph("Solve this - 1:", "1. Move in Day↑ | 2. Explore the house↓ \n3. Breaking News↑ | 4. Pizza Delivery↓ \n5. Broken Windows↑ | 6. Hide in closet↓ \n7. Pizza Boss Fight↑ | 8. Defend Basement↓ \n9. Sewer parkour↑ | 10. Final Boss↓")
	Tab:AddButton({
		Name = "Get Origin Ending - 2",
		Callback = function()
			local previouspos = tostring(game.Players.LocalPlayer.Character.HumanoidRootPart.Position)
			wait(1)
			TeleportTo(CFrame.new(-281.792053, 95.4500275, -790.556946, -0.116918251, -7.95074726e-08, -0.993141532, -2.79918044e-09, 1, -7.97270019e-08, 0.993141532, -6.54155974e-09, -0.116918251))
			originending()
			wait(0.5)
			TeleportTo(CFrame.new(previouspos))
			Notify('Notification!', "Step 2 - Complete", 'rbxassetid://7733911828', 7)
		end
	})
	Tab:AddButton({
		Name = "Get Page - 3",
		Callback = function()
			...
			getpaga()
			task.wait(.3)
			Notify('Notification!', "Step 3 - Complete", 'rbxassetid://7733911828', 7)
		end
	})
	Tab:AddParagraph("How to solve - 4:", "1. Mary \n2. Barry \n3. Larry \n4. Brooke \n5. Luke \n6. The Headmaster")
	]]--
	local Tab = Window:MakeTab({
		Name = "Combat",
	...
	Tab:AddToggle({
		Name = "Auto Hit PizzaGuy",
		Default = false,
		Callback = function(Value)
			getgenv().HitPizz = Value
			while HitPizz do
				hitpizza()
				task.wait(.1)
			end
	...
	Tab:AddButton({
		...
		Callback = function()
			if RemoveSlipping == false then
				...
				Notify('Warning', "Slipping Won't Work Due To Having 'Remove Slipping' Enabled!", 'rbxassetid://7733911828', 7)
			end
		end
	})
	local Section = Tab:AddSection({
